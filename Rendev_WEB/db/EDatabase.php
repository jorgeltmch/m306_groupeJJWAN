	...
	public static function getInstance() {
		if(!self::$objInstance){
			try{
				...
				$dsn = ConnectionParam::EDB_DBTYPE.':host='.ConnectionParam::EDB_HOST.';port='.ConnectionParam::EDB_PORT.';dbname='.ConnectionParam::EDB_DBNAME;
			   	self::$objInstance = new PDO($dsn, ConnectionParam::EDB_USER, ConnectionParam::EDB_PASS, array('charset'=>'utf8'));
